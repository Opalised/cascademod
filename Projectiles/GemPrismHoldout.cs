...
{
	public class GemPrismHoldout : ModProjectile
	{
        ...
        public static Color OverrideColor { get; private set; }
		...
		private void FireBeams()
		{
			...
			{
				Projectile.NewProjectile(projectile.Center, beamVelocity, ModContent.ProjectileType<GemPrismBeam>(), damage, knockback, projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Color drawColor = GemPrismHoldout.OverrideColor;
